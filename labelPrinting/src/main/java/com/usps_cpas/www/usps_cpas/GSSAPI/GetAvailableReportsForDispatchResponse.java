...
public class GetAvailableReportsForDispatchResponse  implements java.io.Serializable {
    private com.usps_cpas.www.usps_cpas.GSSAPI.GetAvailableReportResult getAvailableReportsForDispatchResult;

    public GetAvailableReportsForDispatchResponse() {
    }

    public GetAvailableReportsForDispatchResponse(
           com.usps_cpas.www.usps_cpas.GSSAPI.GetAvailableReportResult getAvailableReportsForDispatchResult) {
     ...
     */
    public com.usps_cpas.www.usps_cpas.GSSAPI.GetAvailableReportResult getGetAvailableReportsForDispatchResult() {
        return getAvailableReportsForDispatchResult;
    }
     ...
     */
    public void setGetAvailableReportsForDispatchResult(com.usps_cpas.www.usps_cpas.GSSAPI.GetAvailableReportResult getAvailableReportsForDispatchResult) {
        this.getAvailableReportsForDispatchResult = getAvailableReportsForDispatchResult;
    }
