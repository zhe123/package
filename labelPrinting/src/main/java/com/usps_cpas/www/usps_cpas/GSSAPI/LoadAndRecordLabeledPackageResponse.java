...
public class LoadAndRecordLabeledPackageResponse  implements java.io.Serializable {
    private com.usps_cpas.www.usps_cpas.GSSAPI.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult;

    public LoadAndRecordLabeledPackageResponse() {
    }

    public LoadAndRecordLabeledPackageResponse(
           com.usps_cpas.www.usps_cpas.GSSAPI.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
     ...
     */
    public com.usps_cpas.www.usps_cpas.GSSAPI.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult getLoadAndRecordLabeledPackageResult() {
        return loadAndRecordLabeledPackageResult;
    }
     ...
     */
    public void setLoadAndRecordLabeledPackageResult(com.usps_cpas.www.usps_cpas.GSSAPI.LoadAndRecordLabeledPackageResponseLoadAndRecordLabeledPackageResult loadAndRecordLabeledPackageResult) {
        this.loadAndRecordLabeledPackageResult = loadAndRecordLabeledPackageResult;
    }
