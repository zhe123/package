...
public class GetDestinationLocationsResponse  implements java.io.Serializable {
    private com.usps_cpas.www.usps_cpas.GSSAPI.DestinationLocationsResult getDestinationLocationsResult;

    public GetDestinationLocationsResponse() {
    }

    public GetDestinationLocationsResponse(
           com.usps_cpas.www.usps_cpas.GSSAPI.DestinationLocationsResult getDestinationLocationsResult) {
     ...
     */
    public com.usps_cpas.www.usps_cpas.GSSAPI.DestinationLocationsResult getGetDestinationLocationsResult() {
        return getDestinationLocationsResult;
    }
     ...
     */
    public void setGetDestinationLocationsResult(com.usps_cpas.www.usps_cpas.GSSAPI.DestinationLocationsResult getDestinationLocationsResult) {
        this.getDestinationLocationsResult = getDestinationLocationsResult;
    }
